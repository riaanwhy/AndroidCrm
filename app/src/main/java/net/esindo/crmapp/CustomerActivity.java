...
import net.esindo.crmapp.Adapter.AdapterCustomer;
...
public class CustomerActivity extends AppCompatActivity implements  SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterCustomer(CustomerActivity.this, itemList);
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, View view,
                ...
                dialog = new AlertDialog.Builder(CustomerActivity.this);
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_select, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    //    Log.i(TAG,"yeah "+obj.getString("alamat"));
                       Customer item = new Customer();
                /*
                        item.setId(obj.getString(TAG_ID));
                        item.setNama(obj.getString(TAG_NAMA));
                        item.setAlamat(obj.getString(TAG_ALAMAT));
                        item.setTelpon(obj.getString(TAG_Tlp));
    ...
    private void simpan_update() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(CustomerActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        }) {
