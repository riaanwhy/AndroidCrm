...
import net.esindo.crmapp.Adapter.AdapterProduk;
...
public class ProdukFragment extends Fragment {
    ...
    private static String URLS    = Server.Url2 + "produk";
    ...
    public List<Produk> list_event = new ArrayList<Produk>();
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, URLS,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response) {
                        ...
                        list_event = Arrays.asList(gson.fromJson(response, Produk[].class));


                        for (Produk prop : list_event) {
                            Log.d("List prngeluaaaaran", ": " + prop.getName());
                        }
...
//                        adapter = new RecyclerAdapter(MainActivity.this,list_pengeluaran);
                        ...
                        AdapterProduk adapterr =  new AdapterProduk(getActivity(),list_event);
